...
class RequirementAskScreen extends StatefulWidget {

  String documentID;

  RequirementAskScreen({super.key, required this.documentID});

  @override
  State<RequirementAskScreen> createState() => _RequirementAskScreenState();
}

class _RequirementAskScreenState extends State<RequirementAskScreen> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Write a discription for what work your are assigning to you assistent",
              ...
              GestureDetector(
                onTap: () async {
                  try{
                    await database.doc(widget.documentID).set({
                    "bossId": FirebaseAuth.instance.currentUser!.uid,
                    "discription": descriptionController.text.trim(),
                  });
                  Navigator.pop(context);
                  sucessMessage("Work Send sucessfully", context);
